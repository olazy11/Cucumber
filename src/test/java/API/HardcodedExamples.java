...
public class HardcodedExamples {
    ...
    String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2ODUxOTY5MTQsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTY4NTI0MDExNCwidXNlcklkIjoiNTM1MiJ9.mBFuiLsgHWJ3jng5Vf1FBHwc6K9F8bq2GTUDws-pxjQ";
    ...
    public void acreateEmployee() {
        ...
        response.then().assertThat().
                body("Employee.emp_firstname", equalTo("Olya"));
        response.then().assertThat().
                body("Employee.emp_lastname", equalTo("Shi"));
